...
export const metadata: Metadata = {
  title: "Admin Login",
  description: "Astra United FC admin authentication."
};
      ...
      <section className="field-grid px-5 py-20 text-white">
        <div className="container-wide max-w-4xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/76">
            Sign in with your admin account using magic-link or email/password authentication. Admin role checks happen on the protected admin route.
          </p>
        </div>
      </section>
